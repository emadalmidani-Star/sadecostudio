    ...
    Tables: {
      ...
      whatsapp_notification_settings: {
        Row: {
          ...
          booking_confirm_template: string | null
          dropin_accepted_enabled: boolean
          dropin_accepted_template: string | null
          project_update_enabled: boolean
          project_update_template: string | null
          updated_at: string
          user_id: string
        }
        Insert: {
