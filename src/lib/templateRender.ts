...
export const FIELDS_BY_TYPE: Record<Template["page_type"], { field: string; kind: "text" | "image"; label: string }[]> = {
  ...
  thankyou: [
    { field: "company_name", kind: "text", label: "Company name" },
    { field: "company_website", kind: "text", label: "Company website" },
    { field: "company_phone", kind: "text", label: "Company phone" },
    { field: "contact", kind: "text", label: "Contact line (combined)" },
    { field: "member_name", kind: "text", label: "Contact name" },
    { field: "member_title", kind: "text", label: "Contact job title" },
    { field: "member_email", kind: "text", label: "Contact email" },
    { field: "member_phone", kind: "text", label: "Contact phone" },
    { field: "member_whatsapp", kind: "text", label: "Contact WhatsApp" },
    { field: "logo", kind: "image", label: "Logo" },
